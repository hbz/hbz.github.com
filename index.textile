...
h2(#common-architecture). Common architecture
...
h3(#macro-architecture). Macro architecture
...
h3(#micro-architecture). Micro architecture
...
h3(#data-modules-lobid-organisations). lobid-organisations
...
h3(#data-modules-mabxml). mabxml-elasticsearch
...
h2(#application-modules). Application modules

Some application modules that are available on GitHub are described below.

h3(#application-modules-nwbib). NWBib
...
h3(#application-modules-edoweb). Edoweb
...
h3(#application-modules-oer-world-map). OER world map
...
h4(#lobid-api-1-monolithic-approach). Monolithic appraoch
...
h4(#lobid-api-1-complex-workflow). Complex workflow
...
h4(#lobid-api-1-generated-json). Generated JSON
...
h3(#lobid-micro-architecture). Lobid micro architecture
...
h4(#lobid-data-modules). Lobid data modules
...
h4(#lobid-application-modules). Lobid application modules
