...
The skos-lookup repo realizes a helper service to support "jQuery autocomplete":https://jqueryui.com/autocomplete/ widgets with "skos":https://www.w3.org/2004/02/skos/ terms over "JSONP":http://bob.ippoli.to/archives/2005/12/05/remote-json-jsonp/. The service can handle arbitrary skos datasets (even larger ones) and provides a simple elasticsearch based lookup. The implementation is oriented on other hbz data modules like "lobid-organisations":https://github.com/hbz/lobid-organisations but generates json from the skos rdf with the standard "jsondld-java":https://github.com/jsonld-java/jsonld-java library.
